...
class TestFasta(unittest.TestCase):
    ...
    def test_read_string(self):
        ...
        self.fasta0.readString('>seq1\nATGCCGTA\n>seq2\nAGGTCC\n>seq3\nGGGGGG')
        self.assertEquals(3, len(self.fasta0.entries))

    def test_trim_seq(self):
        self.fasta1.trimSeq('seq2', 2, 3)
        expected = '>seq1\nATGCCGTA\n>seq2\nATCC\n>seq3\nGGGGGG'
        self.assertEqual(expected, self.fasta1.writeString())
        self.fasta1.trimSeq('seq2', 1, 4)
        expected = '>seq1\nATGCCGTA\n>seq3\nGGGGGG'
        self.assertEqual(expected, self.fasta1.writeString())
